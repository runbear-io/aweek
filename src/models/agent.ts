 ...
 *
 * Plans are implicitly active the moment they land on disk — there is no
 * approval gate. Tasks generated by the weekly-plan generator, daily-review
 * adjustments, and the autonomous next-week planner all flow straight into
 * execution.
 *
