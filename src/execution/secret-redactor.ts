 ...
 *
 * Non-string inputs (`null`, `undefined`, numbers, etc.) are returned
 * unchanged so callers can pass through arbitrary log payloads safely.
 */
export function redactLine(line: unknown): unknown {
 ...
 */
export function __patternsForTest(): ReadonlyArray<RedactionPattern> {
  return PATTERNS;
}
