 ...
 * @returns {0 | 1 | 2 | 3}
 */
function variantIndex(objectiveId) {
  let hash = 0;
 ...
 */
function firstMeaningfulLine(body, maxChars = 130) {
 ...
 */
export function composeAdvisorBrief(objective, {
  planContext = null,
