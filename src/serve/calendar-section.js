...
function projectActivityEntryForDrawer(entry) {
  ...
  // Emit the execution-log URL segment so the drawer's "view execution
  // log" link can resolve it without rebuilding the path on the client.
  // The segment is just the filename stem (no `.jsonl` suffix, no
  // directory).
