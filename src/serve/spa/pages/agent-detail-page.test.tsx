 ...
 */
function renderWithRouter(ui: React.ReactNode, { initialEntries = ['/agents/alice'] }: { initialEntries?: string[] } = {}) {
  return render(
 ...
 */
function makeFetchStub(profile: { slug: string; name: string } & Record<string, unknown>, { ok = true, status = 200, statusText = 'OK' } = {}) {
...
function renderDetail(profile: { slug: string; name: string } & Record<string, unknown>, props = {}, stubOpts = {}) {
