/**
 * Canonical shadcn/ui Sheet primitive — a right/left/top/bottom slide-in
 * built on `@radix-ui/react-dialog`. Used here to surface per-task detail
 * from the calendar grid without a full route change.
 *
